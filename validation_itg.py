...
from types_column_names import ItemizedInvoiceCols, ITGScanHeaders
...
class ITGValidationModel(CustomBaseModel):
  ...
  field_name_lookup: ClassVar[dict[ItemizedInvoiceCols, ITGScanHeaders]] = {
    ItemizedInvoiceCols.Store_Number: ITGScanHeaders.outlet_number,
    ItemizedInvoiceCols.Store_Address: ITGScanHeaders.address_1,
    ItemizedInvoiceCols.Store_Address2: ITGScanHeaders.address_2,
    ItemizedInvoiceCols.Store_City: ITGScanHeaders.city,
    ItemizedInvoiceCols.Store_State: ITGScanHeaders.state,
    ItemizedInvoiceCols.Store_Zip: ITGScanHeaders.zip,
    ItemizedInvoiceCols.DateTime: ITGScanHeaders.transaction_date,
    ItemizedInvoiceCols.Invoice_Number: ITGScanHeaders.market_basket_id,
    ItemizedInvoiceCols.LineNum: ITGScanHeaders.scan_id,
    ItemizedInvoiceCols.Station_ID: ITGScanHeaders.register_id,
    ItemizedInvoiceCols.Quantity: ITGScanHeaders.quantity,
    ItemizedInvoiceCols.Inv_Price: ITGScanHeaders.price,
    ItemizedInvoiceCols.ItemNum: ITGScanHeaders.upc_code,
    ItemizedInvoiceCols.ItemName: ITGScanHeaders.upc_description,
    ItemizedInvoiceCols.Unit_Type: ITGScanHeaders.unit_of_measure,
    ItemizedInvoiceCols.Retail_Multipack_Quantity: ITGScanHeaders.outlet_multipack_quantity,
    ItemizedInvoiceCols.Retail_Multipack_Disc_Amt: ITGScanHeaders.outlet_multipack_discount_amt,
    ItemizedInvoiceCols.Acct_Promo_Name: ITGScanHeaders.acct_promo_name,
    ItemizedInvoiceCols.Acct_Discount_Amt: ITGScanHeaders.acct_discount_amt,
    ItemizedInvoiceCols.Manufacturer_Discount_Amt: ITGScanHeaders.manufacturer_discount_amt,
    ItemizedInvoiceCols.PID_Coupon: ITGScanHeaders.pid_coupon,
    ItemizedInvoiceCols.PID_Coupon_Discount_Amt: ITGScanHeaders.pid_coupon_discount_amt,
    ItemizedInvoiceCols.Manufacturer_Multipack_Quantity: ITGScanHeaders.manufacturer_multipack_quantity,
    ItemizedInvoiceCols.Manufacturer_Multipack_Discount_Amt: ITGScanHeaders.manufacturer_multipack_discount_amt,
    ItemizedInvoiceCols.Manufacturer_Promo_Desc: ITGScanHeaders.manufacturer_promo_desc,
    ItemizedInvoiceCols.Manufacturer_Buydown_Desc: ITGScanHeaders.manufacturer_buydown_desc,
    ItemizedInvoiceCols.Manufacturer_Buydown_Amt: ITGScanHeaders.manufacturer_buydown_amt,
    ItemizedInvoiceCols.Manufacturer_Multipack_Desc: ITGScanHeaders.manufacturer_multipack_desc,
    ItemizedInvoiceCols.Altria_Manufacturer_Multipack_Quantity: ITGScanHeaders.manufacturer_multipack_quantity,
    ItemizedInvoiceCols.Altria_Manufacturer_Multipack_Discount_Amt: ITGScanHeaders.manufacturer_multipack_discount_amt,
    ItemizedInvoiceCols.CustNum: ITGScanHeaders.account_loyalty_id_number,
    ItemizedInvoiceCols.loyalty_disc_desc: ITGScanHeaders.coupon_desc,
  }
