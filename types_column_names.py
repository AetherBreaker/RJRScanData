...
class ITGNamesFinal(ColNameEnum):
  ...
  address_1 = "Outlet Address 1"
  address_2 = "Outlet Address 2"
  city = "Outlet City"
  state = "Outlet State"
  zip = "Outlet Zip Code"
  transaction_date = "Transaction Date/Time"
  market_basket_id = "Market Basket Transaction ID"
  scan_id = "Scan Transaction ID"
  ...
  outlet_multipack_flag = "Outlet Multi-pack Flag"
  outlet_multipack_quantity = "Outlet Multi-pack Quantity"
  outlet_multipack_discount_amt = "Outlet Multi-pack Discount Amount"
  acct_promo_name = "Account Promotion Name"
  acct_discount_amt = "Account Discount Amount"
  manufacturer_discount_amt = "Manufacturer Discount Amount"
  pid_coupon = "Coupon PID"
  pid_coupon_discount_amt = "Coupon Amount"
  manufacturer_multipack_flag = "Manufacturer Multi-pack Flag"
  manufacturer_multipack_quantity = "Manufacturer Multi-pack Quantity"
  manufacturer_multipack_discount_amt = "Manufacturer Multi-pack Discount Amount"
  manufacturer_promo_desc = "Manufacturer Promotion Description"
  manufacturer_buydown_desc = "Manufacturer Buy-down Description"
  manufacturer_buydown_amt = "Manufacturer Buy-down Amount"
  manufacturer_multipack_desc = "Manufacturer Multi-Pack Description"
  account_loyalty_id_number = "Account Loyalty ID Number"
